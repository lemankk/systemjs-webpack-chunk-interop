...
var InjectPlugin = require('webpack-inject-plugin');

function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

var InjectPlugin__default = /*#__PURE__*/_interopDefaultLegacy(InjectPlugin);
...
function loader(options) {
  return function () {
    var _options$shared = options.shared,
        ...
        systemJsInstanceName = _options$systemJsInst === void 0 ? "System" : _options$systemJsInst,
    ...
    }).join("\n"), "\nrequire(\"").concat(systemjs-webpack-chunk-interop, "\");\n\nvar imports = {\n").concat(packageMaps.join(",\n"), "\n};\n\n").concat(systemJsInstanceName, ".appendImportMap(imports);\n    ");
  };
}

var SystemJsWebpackChunkInteropPlugin = /*#__PURE__*/function () {
  ...
  _createClass(SystemJsWebpackChunkInteropPlugin, [{
    ...
    value: function apply(compiler) {
      new InjectPlugin__default['default'](loader(this.options)).apply(compiler);
    }
  }]);
...
module.exports = SystemJsWebpackChunkInteropPlugin;
